 ...
 */
public class RecyclerDilog extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Fees fobj1 = new Fees(118, "27-04-2016", 4000, "Semester Fees", "Online", 1500, 200, 120);

        ArrayList<Fees> objlist = new ArrayList<Fees>();
        objlist.add(fobj1);
        dbHelper.addFees(objlist);
